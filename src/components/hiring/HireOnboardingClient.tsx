...
import { CheckCircle2, FileText, Landmark, Shield } from "lucide-react";
  ...
  return (
    <div className="mx-auto max-w-lg space-y-4 px-4 py-6">
      ...
      {step === "i9" && (
        <div className="rounded-xl border bg-white p-4 space-y-3">
          <h2 className="flex items-center gap-2 font-semibold">
            <Shield className="h-5 w-5" /> Form I-9
          </h2>
      ...
      {step === "w4" && (
        <div className="rounded-xl border bg-white p-4 space-y-3">
          <h2 className="flex items-center gap-2 font-semibold">
            <FileText className="h-5 w-5" /> Form W-4
          </h2>
      ...
      {step === "deposit" && (
        <div className="rounded-xl border bg-white p-4 space-y-3">
          <h2 className="flex items-center gap-2 font-semibold">
            <Landmark className="h-5 w-5" /> Direct deposit
          </h2>
      ...
      {step === "handbook" && policy && (
        <div className="rounded-xl border bg-white p-4 space-y-3">
          ...
          <p className="text-xs text-slate-400">
            Policy {policyIndex + 1} of {HANDBOOK_POLICIES.length}
          </p>
          <Button
            className="w-full"
